    ...
    <>
      ...
      <main>
            ...
            <Col className="offset-md-2 col-md-8">
              <div>
                <p className="lead display-4 fw-medium ">
                  ...
                  The easiest way to{" "}
                  <TypeAnimation
                    sequence={["find", 1000, "start", 1000, "complete", 1000]}
                    speed={50}
                    repeat={Infinity}
                  />
                </p>
        ...
        <Container fluid>
          <Row className="p-5">
            <Col md={7}>
              <p className=" h1 pt-5 px-5 text-md-start fw-normal">
                <br /> <br />
              ...
              <div className="px-5 pt-3 d-md-flex">
                <Link to="/coming-soon">
                  <Button className="btn btn-lg btn-secondary text-white pt-2">
                    Get Started <BsArrowLeftCircle className="spin" />
                  </Button>
                </Link>
              </div>
            </Col>
          ...
          <Row className="p-5 text-center">
            ...
            <Col md={7}>
              ...
              <div className="px-5 py-4 d-md-flex">
                <Link to="/coming-soon">
                  <Button className="btn btn-lg btn-secondary text-white pt-2 spin">
                    Sponsor a learner <BsArrowLeftCircle />
                  </Button>
                </Link>
              </div>
            </Col>
          ...
          <Row className="p-5 pt-5 text-center bg-alt-secondary">
            <Col md={6}>
              ...
              <div className="px-5 pt-3 d-md-flex pb-3">
                ...
                <div className="shadow-sm ms-3 pointer spin">
                  {" "}
          ...
          <Row className="p-5 text-center bg-dark">
            ...
            <Col md={7}>
              ...
              <div className="px-5 py-4 d-md-flex">
                ...
                <div className="shadow-sm ms-3 pointer">
                  {" "}
                  <BsArrowLeftCircle className="spin" />{" "}
                </div>
              </div>
